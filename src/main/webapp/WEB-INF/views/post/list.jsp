	...
	<div class="row mb-3">
		<div class="col">
			<p>
				...
				<a href="form.hta" class="btn btn-primary btn-sm float-end">새 글쓰기</a></p>
				</c : if>
			...
			<nav>
				<ul class="pagination pagination-sm justify-content-center">
					<li class="page-item"><a class="page-link ${pagination.first ? 'disabled' : ''  }" href="list.hta?page=${pagination.prevPage }">이전</a>
					</li>
